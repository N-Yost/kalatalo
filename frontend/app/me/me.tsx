    ...
    <div className="container ms-5 my-4 pe-5">
        <div className="row mb-5">
            <div className="row mb-2">
                <h2>A summary of the obvious</h2>
            </div>
            <div className="row">
                <div className="col-4">
                ...
                <div className="col-8">
                    <p>
                        I am a postdoctoral fellow living in Pasadena, since October 2012. I grew up in Michigan, moved to the Bay Area for graduate school, and have now moved south.<br /><br />
        ...
        <div className="row mb-5">
            <div className="row mb-2">
                <h2>Snippets of the not so obvious</h2>
            </div>
            <div className="row">
                <div className="col-4">
                ...
                <div className="col-8">
                    <p>
                        I have a lot of non-astronomy interests. Beginning from when I was young and horseback rode, became extremely involved in my high school's theatre program, and finally settled into science at university (while also never missing a football game. Go Blue!)<br /><br />
        ...
        <div className="row mb-5">
            ...
            <div className="row">
                ...
                <div className="col-8">
                    <p>
                        Send me an email at the contact info above.<br />
                        Google+ me<br />
                        Add me in LinkedIn
                    </p>
                </div>
